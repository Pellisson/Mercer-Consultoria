...
var style_Mg_7 = function(feature, resolution){
    ...
    if (value >= 0.600000 && value <= 0.734600) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.734600 && value <= 0.799340) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.799340 && value <= 0.877860) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.877860 && value <= 0.969700) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.969700 && value <= 1.200000) {
            style = [ new ol.style.Style({
