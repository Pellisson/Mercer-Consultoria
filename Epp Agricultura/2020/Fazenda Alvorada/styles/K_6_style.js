...
var style_K_6 = function(feature, resolution){
    ...
    if (value >= 0.129300 && value <= 0.176600) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.176600 && value <= 0.200300) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.200300 && value <= 0.223200) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.223200 && value <= 0.244900) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.244900 && value <= 0.350000) {
            style = [ new ol.style.Style({
